...
int main() {
    ...
    cout << "Do you want to measure the time it takes to generate results? (y/n):" << endl;
    char timeoption;
    cin >> timeoption;
    if (timeoption == 'y' || timeoption == 'Y') {
        char fileoption;
    do {
    ...
    try {
        ...
        ofstream belowfile("VECTORbelow5output.txt"); // studentai su below5 isrenkami i output faila
        printHeaderfile(belowfile);
        outputbelow5file(belowfile, below5);
        ofstream abovefile("VECTORabove5output.txt"); // studentai su above5 isrenkami i output faila
        ...
        savetofileList("LISTbelow5ouput.txt", below5list);
        savetofileList("LISTabove5ouput.txt", above5list);
